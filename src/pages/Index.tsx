  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Braunschweig | L&R Friseur</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop L&R Friseur in Braunschweig für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="L&R Friseur | Premium Barbershop Braunschweig" />
        <meta
        ...
        <meta name="twitter:title" content="L&R Friseur | Premium Barbershop Braunschweig" />
        <meta
